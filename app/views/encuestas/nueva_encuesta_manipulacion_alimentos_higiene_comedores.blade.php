						...
						<table class="table table-bordered col-lg-12"> 
							<tr>				
						  	...
						  	@foreach(Etiqueta::getEtiquetasPorPosicion(6)->get() as $etiqueta)
						  		<input type="hidden" name="area_cocina['codigo_area'][{{$etiqueta->id}}]" value="{{Config::get('constants.CODIGOS_AREAS.1')}}">
							  	<tr class="fila-encuesta">
									<td>{{ $etiqueta->titulo }}</td>
							...
							<table class="table table-bordered col-lg-12"> 
								<tr>				
							  	...
							  	@foreach(Etiqueta::getEtiquetasPorPosicion(10)->get() as $etiqueta)
							  		<input type="hidden" name="area_cocina[codigo_area][{{$etiqueta->id}}]" value="{{Config::get('constants.CODIGOS_AREAS.3')}}">
								  	<tr class="fila-encuesta">
										<td>{{ $etiqueta->titulo }}</td>
