...
<div class="col-lg-12">
	<h2>Editar Consumo habitual de alimentos
	...
	<?php switch ($tiempo) {
		case 'desayuno': ?>
		{{$desayuno->isEmpty() ? "div-disabled" : ""}}
	<?php break; case 'media_manana': ?>
		{{$media_manana->isEmpty() ? "div-disabled" : ""}}
	<?php break; case 'almuerzo': ?>
		{{$almuerzo->isEmpty() ? "div-disabled" : ""}}
	<?php break; case 'media_tarde': ?>
		{{$media_tarde->isEmpty() ? "div-disabled" : ""}}
	<?php break; case 'merienda': ?>
		{{$merienda->isEmpty() ? "div-disabled" : ""}}
	<?php
		break;
		default:
			# code...
	...
	'>
		<div class="row">
			<div class="col-sm-6 col-lg-2">
				...
				<?php switch ($tiempo) {
					case 'desayuno': ?>
					<input {{$desayuno->isEmpty() ? "checked" : ""}} type="checkbox" name="no_aplica_{{$tiempo}}" value="{{$desayuno->isEmpty() ? 1 : 0}}" onclick="desactiva_tiempo('{{$tiempo}}')" id="no_aplica_{{$tiempo}}">
				<?php break; case 'media_manana': ?>
					<input {{$media_manana->isEmpty() ? "checked" : ""}} type="checkbox" name="no_aplica_{{$tiempo}}" value="{{$media_manana->isEmpty() ? 1 : 0}}" onclick="desactiva_tiempo('{{$tiempo}}')" id="no_aplica_{{$tiempo}}">
				<?php break; case 'almuerzo': ?>
					<input {{$almuerzo->isEmpty() ? "checked" : ""}} type="checkbox" name="no_aplica_{{$tiempo}}" value="{{$almuerzo->isEmpty() ? 1 : 0}}" onclick="desactiva_tiempo('{{$tiempo}}')" id="no_aplica_{{$tiempo}}">
				<?php break; case 'media_tarde': ?>
					<input {{$media_tarde->isEmpty() ? "checked" : ""}} type="checkbox" name="no_aplica_{{$tiempo}}" value="{{$media_tarde->isEmpty() ? 1 : 0}}" onclick="desactiva_tiempo('{{$tiempo}}')" id="no_aplica_{{$tiempo}}">
				<?php break; case 'merienda': ?>
					<input {{$merienda->isEmpty() ? "checked" : ""}} type="checkbox" name="no_aplica_{{$tiempo}}" value="{{$merienda->isEmpty() ? 1 : 0}}" onclick="desactiva_tiempo('{{$tiempo}}')" id="no_aplica_{{$tiempo}}">
				<?php
					break;
					default:
						# code...
