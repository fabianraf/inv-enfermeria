...
<div class="col-lg-12">
  <h2>Encuestas de frecuencia de consumo de alimentos en los bares de la Universidad </h2>
  <hr>
  </br>
    <table class="table table-no-border ">
      <tr>              
        ...
        <?php echo "<td style='text-align:left'><a href='/reportes/consumo_alimentos_bares/".$usuario->id."'><span class='glyphicon glyphicon-search'></span></td>";?>
      </tr>     
        @endforeach
    </table>
  </div>
