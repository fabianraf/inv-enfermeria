...
class CreateEmcAreaMaterialesLimpieza extends Migration {
	...
	public function up()
	{
		Schema::create('emc_area_materiales_limpieza', function(Blueprint $table) {
			$table->increments('id');
	...
	{
		Schema::drop('emc_area_materiales_limpieza');
	}
