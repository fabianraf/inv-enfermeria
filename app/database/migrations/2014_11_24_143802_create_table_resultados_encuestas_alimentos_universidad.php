...
class CreateTableResultadosEncuestasAlimentosUniversidad extends Migration {
	...
	public function up()
	{
		Schema::create('resultados_encuestas_alimentos_universidad', function(Blueprint $table) {
			$table->increments('id');
	...
	{
		Schema::drop('resultados_encuestas_alimentos_universidad');
	}
