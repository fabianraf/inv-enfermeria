...
public function run()
    {
        ...
        AlimentoBares::create(array(
            'nombre'  => 'Ensalada de pollo, pavo, queso mozzarella y cheddar, aguacate, lechuga, tomate y cebolla morada',
            'porciones' => '',
            'tipo_de_alimento_bar_id' => '8',            
        ));
        ...
        AlimentoBares::create(array(
            'nombre'  => 'Ensalada Santa fé (queso mozzarella y cheddar, lechuga, tomate, cebolla, culantro, aguacate, frejol, maíz dulce, tortilla y BBQ',
            'porciones' => '',
            'tipo_de_alimento_bar_id' => '8',            
        ));
        ...
        AlimentoBares::create(array(
            'nombre'  => 'Pollo a la mostaza y miel (tocino, queso cheddar, lechuga, tomate, cebolla, mostaza y miel)',
            'porciones' => '',
            'tipo_de_alimento_bar_id' => '8',            
        ));
        ...
        AlimentoBares::create(array(
            'nombre'  => 'Sánduche Beef especial (roast beef, queso cheddar y mozzarella, hongos y cebolla)',
            'porciones' => '',
            'tipo_de_alimento_bar_id' => '8',            
        ));
        ...
        AlimentoBares::create(array(
            'nombre'  => 'Sánduche Philly roast beef (roast beef, queso mozzarella y suizo, cebolla y pimiento)',
            'porciones' => '',
            'tipo_de_alimento_bar_id' => '8',            
        ));

        AlimentoBares::create(array(
            'nombre'  => 'Sánduche de pollo con mostaza y miel (pollo, tocino, queso cheddar, lechuga, tomate y cebolla)',
            'porciones' => '',
            'tipo_de_alimento_bar_id' => '8',            
        ));
